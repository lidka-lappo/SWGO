import ast
import shutil
from filters import at_least_two_rpcs_and_one_scint, at_least_two_rpcs_fired, fancy_trigger, filter_by_charge, filter_by_time
...
import os
import glob
base_folder = Path("/home/lidka/SWGO/SKAN2") # change this to your main folder path
...
# base_folder = "/home/lidka/SWGO/SKAN3"  # change this to your main folder path
# df = load_all_steps(base_folder, triggerType)
#####################################################
